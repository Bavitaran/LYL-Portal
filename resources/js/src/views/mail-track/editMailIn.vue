<template>
  <b-card title="Update Incoming Mail Track ">
        ...
        <b-row>
          ...
          <b-col md="6">
            <b-form-group>
              ...
              <validation-provider #default="{ errors }" rules="date">
                <b-form-input placeholder="Date" v-model="date" type="date" />
                <small class="text-danger">{{ errors[0] }}</small>
              </validation-provider>
            </b-form-group>
          </b-col>
          ...
          <b-col md="6">
            <b-form-group>
              ...
              <validation-provider #default="{ errors }" rules="date">
                <b-form-input
                  placeholder="Document Collection Date"
                  v-model="due_date"
                  type="date"
                />
                <small class="text-danger">{{ errors[0] }}</small>
          ...
          <b-col md="6">
            <b-form-group>
              <label>LYL Received Date</label>
              <validation-provider #default="{ errors }" rules="date">
                <b-form-input
                  placeholder="LYL Received Date"
                  v-model="incoming"
                  type="date"
                />
                <small class="text-danger">{{ errors[0] }}</small>
