  ...
  <b-card>
    <b-row>
      <b-col md="12" class="text-right">
        ...
        >
          <b-dropdown-item :to="{ path: '/add-invoice' }"
            >Invoice Quotation</b-dropdown-item
          >
          <b-dropdown-item :to="{ path: '/add-outstanding' }"
            >Outstanding Payment</b-dropdown-item
          >
          <b-dropdown-item :to="{ path: '/add-others' }"
            >Others Payment</b-dropdown-item
          >
        </b-dropdown>
      </b-col>
    </b-row>
