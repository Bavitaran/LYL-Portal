<template>
  <section class="invoice-add-wrapper">
    <validation-observer ref="invoiceForm">
      <b-form class="auth-register-form mt-2" @submit.prevent="invoice($data)">
            ...
            <b-form @submit.prevent>
              <b-card no-body class="invoice-preview-card">
                        ...
                        <div class="d-flex border rounded">
                          ...
                          /> -->
                            ...
                            <b-col cols="12" lg="2">
                              ...
                              <!-- <p class="mb-1">${{ rForm.cost * rForm.quantity }}</p> -->
                              <b-form-input
                                v-model="rForm.price"
                                :value="rForm.cost * rForm.quantity"
                                type="text"
                                disabled
                                :placeholder="rForm.cost * rForm.quantity"
                                class="mb-2"
                              />
                            </b-col>
                            <b-col cols="12" lg="5">
                ...
                <b-card-body class="invoice-padding pt-0">
                  ...
                  <b-form-textarea v-model="rForm.note" />
                </b-card-body>
              </b-card>
            </b-form>
          </b-col>
          ...
          <b-col cols="12" md="4" xl="3" class="invoice-actions mt-md-0 mt-2">
            ...
            <div class="mt-2">
              ...
              >
                ...
                <b-form-checkbox id="clientNotes" v-model="rForm.client_notes" switch />
              </div>

              <!-- Payment Stub -->
              <div class="d-flex justify-content-between align-items-center">
                <label for="paymentStub">Payment Stub</label>
                <b-form-checkbox id="paymentStub" v-model="rForm.payment_stub" switch />
              </div>
            </div>
          </b-col>
        </b-row>
  ...
  methods: {
    invoice() {
      this.$refs.invoiceForm.validate().then((success) => {
        if (success) {
          this.$http.post("/api/auth/invoice", this.rForm).then((response) => {
