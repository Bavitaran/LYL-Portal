            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form class="row" @submit="formSubmit" method="POST" enctype="multipart/form-data">
                        <div class="form-group col-md-6">
                            <label for="document_name">Document Name:</label>
                            <input id="document_name" type="text" class="form-control" v-model="document_name">
                            </div>
                            <div class="form-group col-md-6">
                            <label for="document_name">File Ref:</label>
                            <input id="document_name" type="text" class="form-control" v-model="document_name">
                            </div>
                        <div class="form-group col-md-12">
                            <label for="description">Description:</label>
                            <textarea id="description" type="text" class="form-control" v-model="description"></textarea>
                            </div>
                            <div class="form-group col-md-12">
                            <label for="docs">Choose file:</label>
                            <input id="docs" type="file" class="form-control" v-on:change="onChange">
                            </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tbody v-if="file_uploads.length > 0">
                                <tr class="text-center" v-for="(file_upload,key) in file_uploads" :key="key">
                                    ...
                                    <td>
                                        ...
                                        <a style="color:#7367f0" @click="deletefile_uploads(file_upload.id)"><i class="fa-solid fa-trash-can"></i></a>
...
import axios from "axios";
    export default {
        ...
        methods: {
            ...
            await this.axios.get('/api/auth/documents').then(response=>{
        ...
        deletefile_uploads(id){
            if(confirm("Are you sure to delete this Documnet ?")){
                this.axios.delete(`/api/auth/documents/${id}`).then(response=>{
                    this.getfile_uploads()
            ...
            formSubmit(e) {
                ...
                axios.post('/api/auth/documents', data, config)
                    .then(function (res) {
